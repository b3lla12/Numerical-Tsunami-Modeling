...
files = sorted(glob.glob(os.path.join(folder, "z_02_*.dat")))

print("Jumlah file:", len(files))

if len(files) == 0:
    print("❌ File z_02 tidak ditemukan!")
    exit()
...
np.savetxt(
    r"D:\python file skripsi\max_eta_layer02_geo.csv",
...
np.savetxt(
    r"D:\python file skripsi\arrival_time_layer02_geo.csv",
